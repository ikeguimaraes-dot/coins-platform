function SkeletonRow() {
  return (
    <div className="flex items-center justify-between gap-4 border-t px-1 py-3.5 first:border-t-0">
      ...
      <div className="hidden h-8 w-40 animate-dashboard-shimmer rounded sm:block" />
    </div>
  )
}
